package com.algorithm.implementation.sort;
...
public class MergeSorter implements ListSorter {
	...
	private void mergeSort(int[] list, int lengthArray) {
		...
		return;
			...
			merge(leftArray, rightArray, list, mid, lengthArray-mid);
		}
	

	private void merge(int[] leftArray, int[] rightArray, int[] list, int mid, int i) {
		int leftIndex = 0;
		int rightIndex = 0;
		int targetIndex = 0;
